    ...
    return (
        ...
        <Box px='8' mt='10'>
            ...
            <Flex gap='6' mt='8' flexDirection={['column', 'column', 'column', 'row']} justify={'space-between'}> 
                ...
                <Expenses amount={'150,000.00'} color="green.500" title="Total Income" iconPercent={<FaArrowUp />} symbol={<GrMoney />} percentAmount={8.9} />

                <Expenses amount={'50,000.00'} color="red.500" title="Total Expense" iconPercent={<FaArrowDown />} symbol={<GrMoney />} percentAmount={8.9} />
            </Flex>
